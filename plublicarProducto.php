...
<div class=" form-group col-md-4 mb-4">
      <label class="Estado">Comuna</label>
      <select class="custom-select browser-default  " id="Ciudad" name="Ciudad"   title="Ingrese Estado "  required >
      <option value="">Elegir</option>  
      <option value="Activo">serena</option>
  ...
  <div class="form-group">
    ...
    <br>
    <br>
      <label for="nomape">descripción</label>
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      <label for="mac">agregar imagen</label>
